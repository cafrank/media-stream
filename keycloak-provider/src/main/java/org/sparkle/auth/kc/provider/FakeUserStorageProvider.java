...
@Slf4j
public class FakeUserStorageProvider implements UserStorageProvider,
        UserLookupProvider,
    ...
    public FakeUserStorageProvider(KeycloakSession ksession, ComponentModel model) {
    ...
    public Stream<UserModel> searchForUserStream(RealmModel realm, String foo, Integer firstResult, Integer maxResults) {
        ...
        for (int i = 0; i < 5; i++) {
            UserModel m = new MyUserModel("f:"+model.getId() +":cfrank"+ i, "cfrank"+i, "cfrank"+ i +"@osafo.com", "Colin"+i, "Frank"+i);
            list.add(m);
        }
    ...
    public boolean isValid(RealmModel realmModel, UserModel userModel, CredentialInput credentialInput) {
        ...
        log.info("   challengeResponse:  "+credentialInput.getChallengeResponse());
        return true;
    }
